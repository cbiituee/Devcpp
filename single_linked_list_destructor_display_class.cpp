//Singly Linked List with destructor to release all the memory used by the list
//by stepping through the list, deleteing each node one by one
#include<iostream>
using namespace std;
...
class SLL     // class SLL decralation
{
  ...
  public: 
          ...
          void insertNode (float);// prtotype of insertNode function to add node at correct order
