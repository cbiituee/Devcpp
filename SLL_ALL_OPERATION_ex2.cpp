//Sample sll without memory leakage in dellast()
#include<iostream>
#include<cstdlib>
using namespace std;
...
void list:: dellast()
{
	...
	while(q->link->link!=NULL)
		q=q->link;
		if (q->link->link==NULL)// to avoid memory leakage
		{t = q->link; delete t;}
	    q->link=NULL;
	return;
}
...
do
{
	...
	cout<<"1.Insertion"<<endl<<"2.Deletion"<<endl<<"3.Display"<<endl<<"4.Seek"<<endl<<"5.Exit"<<endl;
	...
	case 2:
		cout<<"1.Delete the first element 2.Delete the last element"<<endl;
